...
public class ZXingUtil {
     ...
     * @throws IOException
     */
    public static void encodeimage(String imagePath , String format , String content , int width , int height , InputStream logo) throws WriterException, IOException {
     ...
     * @throws IOException
     */
    public static BufferedImage logoImg(BufferedImage matrixImage , InputStream logo) throws IOException{
